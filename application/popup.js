...
{    
  ...
  document.getElementById('500px').addEventListener('click', searchByTag);
  document.getElementById('google').addEventListener('click', googleAuth);
};
...
function googleAuth()
{
  chrome.identity.getAuthToken({
    interactive: true, scopes: ["https://www.googleapis.com/auth/userinfo.email"]
  }, function(token) {
    console.log(token);
...
function searchByTag()
{
  ...
  {
    _500px.init({
      sdk_key: 'ec55f37c9273af827b9840ccb636a5b163f33b7d'
    });
    init = true;
  }

  const tags = document.getElementById("path").value.split(" ");

  var table = document.getElementById("invisible_table");
  //table.innerHTML = "";

  tags.forEach(function(tag) {
    _500px.api('/photos/search', {tag, rpp:100, image_size: 2048}, function (response) {
      ...
      _500px.api('/photos/search', {tag, page: randomPage, rpp:100, image_size: 2048}, function (response) {
        ...
        response.data.photos.forEach(function(element) {
          ...
          tr.innerHTML = element.image_url;
...
// function picsDemo() 
// {
//   if(document.getElementById("is_table_full").value != "true")
//     return;

//   let usedPics = [];
//   tablePics = document.getElementById("size_table");
//   table = document.getElementById("invisible_table");
//   for(let i = 0; i < table.childNodes.length; i+=1)
//   {
//     do {
//       let rand = randomInt(0, table.childNodes.length);
//     } while(usedPics.includes(rand));

//     usedPics[usedPics.length] = rand;

//     var tr = document.createElement("tr");
//     var td = document.createElement("td");
//     var img = document.createElement("img");
//     img.src = table[i].innerText;
//     td.appendChild(img);
//     tr.appendChild(td);
//     tablePics.appendChild(tr);
//   }
// };
